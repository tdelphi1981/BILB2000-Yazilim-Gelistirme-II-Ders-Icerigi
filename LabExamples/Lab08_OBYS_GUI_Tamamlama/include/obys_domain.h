...
struct Ogrenci {
    ...
    QString numara;
    QString adSoyad;
    // GOREV-1: (Lab 08 / Calisma 2 / Talep 1) Transkripte fotograf alani
    // eklemek icin asagiya "QString fotografYolu;" alanini ekleyin.
    // Varsayilani bos string olmalidir (fotografsiz ogrenciler icin).
    //
    // Ipucu:
    //     QString fotografYolu;
};
...
inline QDataStream& operator<<(QDataStream& s, const Ogrenci& o) {
    ...
    // GOREV-2: (Lab 08 / Calisma 2 / Talep 1) Yeni eklenen fotografYolu
    // alanini da akisa yazin. Eski dosyalarla uyumluluk icin
    // PersistenceManager::VERSION sabitini 1'den 2'ye cikarmayi unutmayin.
    //
    // Ipucu:
    //     s << o.fotografYolu;
    return s;
...
inline QDataStream& operator>>(QDataStream& s, Ogrenci& o) {
    ...
    o.id = id;
    // GOREV-3: (Lab 08 / Calisma 2 / Talep 1) fotografYolu alanini
    // akistan okuyun. Eski surum (v1) dosyalarinda bu alan yoktur;
    // PersistenceManager surum bilgisine gore kosullu okuma yapmak
    // icin dosya yukleme mantigini da guncellemeniz gerekecek.
    // Basit baslangic: her zaman okumayi deneyin ve surum
    // yukseltildikten sonra calisin.
    //
    // Ipucu:
    //     s >> o.fotografYolu;
    return s;
