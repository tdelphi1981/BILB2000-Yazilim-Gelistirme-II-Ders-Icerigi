                             ...
                             const OBYSServis& servis)
{
    ...
    // GOREV-9: (Lab 08 / Calisma 4 / Talep 1) Kok nesneye "kayitlar"
    // anahtariyla bir QJsonArray ekleyin. Her DersKaydi icin
    // ogrenciNo (Ogrenci.numara), dersKodu (Ders.kod), "not" (sayisal
    // deger veya MUAF) ve harfNotu alanlarini iceren bir nesne
    // olusturun. Ogrenci ve ders kayitlarini bulmak icin servis
    // uzerinden dogrudan erisim kullanabilirsiniz.
    // Cikti python3 -m json.tool ile gecerli dogrulanmalidir.
    //
    // Ipucu:
    //     QJsonArray kayitArr;
    //     for (const auto& k : servis.tumNotlar()) {
    //         QJsonObject kj;
    //         // ogrenciyi ve dersi servis uzerinden bul...
    //         kj["ogrenciNo"] = /* ... */;
    //         kj["dersKodu"] = /* ... */;
    //         kj["not"]      = /* sayisal deger veya "MUAF" */;
    //         kj["harfNotu"] = /* ... */;
    //         kayitArr.append(kj);
    //     }
    //     kok["kayitlar"] = kayitArr;
