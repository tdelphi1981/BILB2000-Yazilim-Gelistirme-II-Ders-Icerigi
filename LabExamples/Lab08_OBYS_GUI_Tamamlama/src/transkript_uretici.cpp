                                ...
                                const QList<DersKaydi>& kayitlar) const
{
    ...
    // GOREV-5: (Lab 08 / Calisma 2 / Talep 3) Ogrenci fotografYolu
    // bos degilse HTML govdesinin basina sabit genislikli bir
    // <img> etiketi ekleyin. QTextDocument yerel dosya yollarini
    // "file://" semasi ile coz(umleye)bilir. Fotografsiz ogrencilerde
    // mevcut duzen aynen korunmalidir (asagida hicbir sey eklemeyin).
    //
    // Ipucu:
    //     if (!ogrenci.fotografYolu.isEmpty()) {
    //         govde += QStringLiteral(
    //             "<img src=\"file://%1\" width=\"120\" "
    //             "style=\"float:right;\"/>")
    //             .arg(ogrenci.fotografYolu);
    //     }
