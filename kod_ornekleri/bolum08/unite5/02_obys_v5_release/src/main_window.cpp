...
void MainWindow::menuleriKur() {
    ...
    m_yeniAction = dosyaMenu->addAction(
        QIcon(":/icons/yeni.svg"), tr("&Yeni"));
    m_yeniAction->setShortcut(QKeySequence::New);
    connect(m_yeniAction, &QAction::triggered,
            this, &MainWindow::dosyaYeni);

    m_acAction = dosyaMenu->addAction(
        QIcon(":/icons/ac.svg"), tr("&Aç..."));
    ...
    m_sonAcilanlarMenu = dosyaMenu->addMenu(
        QIcon(":/icons/son_acilanlar.svg"), tr("Son A&çılanlar"));

    dosyaMenu->addSeparator();

    m_kaydetAction = dosyaMenu->addAction(
        QIcon(":/icons/kaydet.svg"), tr("&Kaydet"));
    m_kaydetAction->setShortcut(QKeySequence::Save);
    connect(m_kaydetAction, &QAction::triggered,
            this, [this]() { (void)dosyaKaydet(); });

    m_farkliKaydetAction = dosyaMenu->addAction(
        QIcon(":/icons/farkli_kaydet.svg"), tr("&Farklı Kaydet..."));
    ...
    auto* disaAktarMenu = dosyaMenu->addMenu(
        QIcon(":/icons/disa_aktar.svg"), tr("&Dışa Aktar"));
    ...
    m_transkriptAction = dosyaMenu->addAction(
        QIcon(":/icons/yazdir.svg"), tr("Transkript Ya&zdır..."));
    ...
    m_topluRaporAction = dosyaMenu->addAction(
        QIcon(":/icons/toplu_rapor.svg"), tr("Toplu &Rapor..."));
    ...
    m_cikisAction = dosyaMenu->addAction(
        QIcon(":/icons/cikis.svg"), tr("Çı&kış"));
    ...
    auto* notEkleAction = duzenMenu->addAction(
        QIcon(":/icons/not_ekle.svg"), tr("&Not Ekle..."));
    ...
    m_aydinlikTemaAction = gorunumMenu->addAction(
        QIcon(":/icons/aydinlik_tema.svg"), tr("&Aydınlık Tema"));
    ...
    m_karanlikTemaAction = gorunumMenu->addAction(
        QIcon(":/icons/karanlik_tema.svg"), tr("&Karanlık Tema"));
    ...
    m_hakkindaAction = yardimMenu->addAction(
        QIcon(":/icons/hakkinda.svg"), tr("&Hakkında..."));
